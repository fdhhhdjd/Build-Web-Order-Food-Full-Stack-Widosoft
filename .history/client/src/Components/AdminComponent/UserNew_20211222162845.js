        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="newUserItem">
            ...
            <div className="newUserGender">
              <input
                ...
                id="gioitinh"
                name="gioitinh"
                checked={user[user.gioitinh === 1] || user.gioitinh === 1}
                onChange={handleChangeInput}
              />
              ...
              <input
                ...
                id="gioitinh"
                value="0"
                checked={user[user.gioitinh === 0] || user.gioitinh === 0}
                onChange={handleChangeInput}
              />
          ...
          <div className="newUserItem">
            ...
            >
              ...
              <option value={user.admin} selected={user.admin === 1}>
                Admin
              </option>
              <option value={user.admin} selected={user.admin === 0}>
                Customer
              </option>
            </select>
          </div>
