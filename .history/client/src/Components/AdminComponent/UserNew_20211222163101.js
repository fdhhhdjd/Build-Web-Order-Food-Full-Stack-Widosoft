        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="newUserItem">
            ...
            >
              ...
              <option value="admin" name="admin" selected={user.admin === 1}>
                Admin
              </option>
              <option value="admin" name="admin" selected={user.admin === 0}>
                Customer
              </option>
            </select>
          </div>
