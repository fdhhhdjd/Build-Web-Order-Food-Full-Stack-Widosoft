  ...
  useEffect(() => {
    if (id) {
      allUsers.forEach((product) => {
        if (product.id === id) setDetailUser(product);
        console.log(product, "okeeee");
      });
    }
  }, [id, allUser]);
          ...
          <div className="userShow">
            <div className="userShowTop">
              ...
              <div className="userShowTopTitle">
                <span className="userShowUsername">
                  {`${detailUser.hoten}`}
                  {console.log(detailUser.hoten, "alllllll")}
                </span>
            ...
            <div className="userShowBottom">
              ...
              <div className="userShowInfo">
                ...
                <span className="userShowInfoTitle">{detailUser.username}</span>
              </div>
              <div className="userShowInfo">
                <WcIcon className="userShowIcon" />
                <span className="userShowInfoTitle">
                  {(detailUser.gioitinh === 1 && "Nam") ||
                    (detailUser.gioitinh === 0 && "Nữ ")}
                </span>
              </div>
              <div className="userShowInfo">
                <CalendarToday className="userShowIcon" />
                <span className="userShowInfoTitle">
                  {moment(`${detailUser.ngaysinh}`).format("Do MMM YYYY")}
                </span>
              </div>
