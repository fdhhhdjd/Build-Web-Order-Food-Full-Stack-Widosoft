...
const User = () => {
  ...
  const { hoten, username, ngaysinh, email, dienthoai, gioitinh } = product;
  const { id } = useParams();
  ...
  console.log(product, "chans");
  if (allUsers.length === 0) return <NotFound />;
  return (
    <>
      <UserStyle />
      <div className="user">
          ...
          <div className="userShow">
            <div className="userShowTop">
              ...
              <div className="userShowTopTitle">
                <span className="userShowUsername">{`${product.hoten}`}</span>
            ...
            <div className="userShowBottom">
              ...
              <div className="userShowInfo">
                ...
                <span className="userShowInfoTitle">
                  {(product.gioitinh === 1 && "Nam") ||
                    (product.gioitinh === 0 && "Nữ ")}
                </span>
              </div>
              <div className="userShowInfo">
                <CalendarToday className="userShowIcon" />
                <span className="userShowInfoTitle">
                  {moment(`${product.ngaysinh}`).format("Do MMM YYYY")}
                </span>
              </div>
              <span className="userShowTitle">Contact Details</span>
              <div className="userShowInfo">
                <PhoneAndroid className="userShowIcon" />
                <span className="userShowInfoTitle">{product.dienthoai}</span>
              </div>
              <div className="userShowInfo">
