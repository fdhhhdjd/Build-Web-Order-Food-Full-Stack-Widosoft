...
const AuthReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case types.DELETE_ALL_USER_ADMIN_START:
      return {
        ...state,
        loading: true,
      };
    ...
    case types.DELETE_ALL_USER_ADMIN_SUCCESS:
      return {
        ...state,
        loading: false,
        // deleteUser: action.payload,  // deleteUser: action.payload,
      };
    ...
    case types.DELETE_ALL_USER_ADMIN_FAIL:
      return {
        ...state,
        loading: false,
