...
public class HotThisMonthAdapter extends RecyclerView.Adapter<HotThisMonthAdapter.ItemViewHolder>{

    private Context mContext;
    private List<Hot> mItemPizzaList;


    public HotThisMonthAdapter(Context context, List<Hot> item1) {
        mContext = context;
